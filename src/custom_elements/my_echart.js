...
//SECTION - changed observer handling
    //(-)
    ...
    //(+)
    // resize observer more suitable for a lot of datapoints and no chart animations,
    // ensures that the chart is initially only rendered once
    const resizeObserver = new ResizeObserver(this.chart.resize).observe(this.$el);
//!SECTION
