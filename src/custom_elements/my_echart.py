...
#SECTION - solved imports to original nicegui package
#(-)
...
from nicegui.events import EChartPointClickEventArguments, GenericEventArguments, Handler, handle_event
#!SECTION
...
#SECTION - edited class name, component file 
#(-)
# class EChart(Element,
            #  component='echart.js',
#(+)
class MyEChart(Element,
             component='my_echart.js',
#!SECTION
